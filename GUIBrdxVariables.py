...
class BrdxVariables(Container):
    ...
    async def GetScreenChange(self):
        ...
        if self.ScreenName == 'BrdxVariablesScreen': self.ReportScreen = GF.FormScreen(self.page, self.Download, self.Query, self.ScreenName, self.ReportTitle).GetFormScreen()
        elif self.ScreenName == 'SelectedProductScreen': self.ReportScreen = GVE.FormEditScreen(self.page, self.Download, self.Query, self.ScreenName, self.ReportTitle).GetFormEditScreen()
        elif self.ScreenName == 'MainScreen': self.ReportScreen = Brdx.Bordereaux(self.page, self.Download).ReportingScreen
