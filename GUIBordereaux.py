...
class Bordereaux(Container):
    ...
    async def GetNavigateFront(self, e):
        ...
        if LabelName == "Bordereaux Reports": MainScreen = BrdxReport.BrdxReports(self.page, self.Download).ReportingScreen; await self.UpdateScreen(MainScreen)
        elif LabelName == "Bordereaux Templates": MainScreen = BrdxTemplate.BrdxTemplates(self.page, self.Download).ReportingScreen; await self.UpdateScreen(MainScreen)
        elif LabelName == "Bordereaux Variables": MainScreen = BrdxVariables.BrdxVariables(self.page, self.Download).ReportingScreen; await self.UpdateScreen(MainScreen)
        print(LabelName)
